...
class TestCsvReader(unittest.TestCase):
    ...
    def test_multi_threaded_reader_output(self):
        ...
        output.
        """
        data_paths = ['mltoolkit/mldp/tests/data/small_chunks/chunk1.csv',
                      'mltoolkit/mldp/tests/data/small_chunks/chunk2.csv',
                      'mltoolkit/mldp/tests/data/small_chunks/chunk3.csv']
        chunk_size = 2
