...
class TestJsonReader(unittest.TestCase):
    ...
    def test_reading_from_tree_json(self):
        csv_data_path = 'mltoolkit/mldp/tests/data/mock_data.csv'
        json_data_path = 'mltoolkit/mldp/tests/data/json_reading/mock_data_as_tree.json'
    ...
    def test_reading_from_list_json(self):
        csv_data_path = 'mltoolkit/mldp/tests/data/mock_data.csv'
        json_data_path = 'mltoolkit/mldp/tests/data/json_reading/mock_data_as_dict.json'
        sorter = ChunkSorter('id', order='ascending')
