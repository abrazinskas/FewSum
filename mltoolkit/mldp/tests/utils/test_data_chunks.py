...
class TestDataChunks(unittest.TestCase):
    ...
    def test_json_writing_tree(self):
        ...
        expected_output_fp = "mltoolkit/mldp/tests/data/chunk_writing/expected_tree_dump.json"
    ...
    def test_json_writing(self):
        ...
        expected_output_fp = "mltoolkit/mldp/tests/data/chunk_writing/expected_dump.json"
        with open(expected_output_fp) as f:
            expected_output = json.load(f)
