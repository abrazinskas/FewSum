...
from mltoolkit.mlutils.helpers.argparse import str2bool, str2list, str2floatlist, str2intlist
...
class BaseConfig(object):
    ...
    file. Can be also used to store configuration parameters of run files.
    ...
    def save(self, file_path, encoding='utf-8'):
        ...
        logger.debug("Extracted the following config: '%s'."
                     "" % " ".join(params.keys()))
